...
export const ResultsSection: React.FC<ResultsSectionProps> = ({ data }) => {
  ...
  return (
    <section className="py-20 px-6 bg-gradient-to-b from-pink-light/30 to-white">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-12">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <Card className="p-8 bg-gradient-to-br from-primary/5 to-pink-light/50 border-primary/20 h-full">
        ...
        <motion.div
          ...
          className="mt-12"
        >
          <Card className="p-6 bg-gradient-to-r from-nude/50 to-pink-light/30 border-primary/20">

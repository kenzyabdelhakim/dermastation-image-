            ...
            >
              ...
              <div className="px-6 pb-6 space-y-4">
                ...
                <div className="recommendation-reason">
                  <p className="text-sm text-soft-white leading-relaxed font-light">
                    {product.reason}
                  </p>
                </div>
                ...
                <div className="flex flex-wrap gap-2">
                  {product.tags.slice(0, 2).map((tag, idx) => (
                    <span
                      key={idx}
                      className="px-3 py-1 text-xs glass-editorial rounded-full border-baby-pink text-primary tracking-wide"
                    >
                      {tag}
                    </span>
                  ))}
